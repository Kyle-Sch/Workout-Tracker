...
namespace WebApplication.Web.Providers.Auth
{
    ...
    public class SessionAuthProvider : IAuthProvider
    {
        ...
        public static string SessionKey = "Auth_Username";
        public static string SessionIsCheckedIn = "Auth_Checked_In";
        ...
        public bool SignIn(string username, string password)
        {
            ...
            {                
                Session.Set<string>(SessionKey, user.Username);
                return true;
            }
        ...
        {
            var username = Session.Get<string>(SessionKey);

            if (!String.IsNullOrEmpty(username))
            {
                return userDAL.GetUserWithDapper(username);
            }
